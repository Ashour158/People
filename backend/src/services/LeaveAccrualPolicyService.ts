...
export class LeaveAccrualPolicyService {
  ...
  private mapRowToPolicy(row: any): LeaveAccrualPolicy {
    return {
      ...
      leave_type_id: row.leave_type_id || undefined,
      accrual_type: row.accrual_type,
      accrual_frequency: row.accrual_frequency || undefined,
      calculation_method: row.calculation_method,
      days_per_period: row.days_per_period ? parseFloat(row.days_per_period) : undefined,
      max_accrual_days: row.max_accrual_days ? parseFloat(row.max_accrual_days) : undefined,
      tier_rules: row.tier_rules || undefined,
      accrual_rule_expression: row.accrual_rule_expression || undefined,
      eligibility_criteria: row.eligibility_criteria || undefined,
      minimum_service_days: row.minimum_service_days || undefined,
      ...
      carry_forward_expiry_months: row.carry_forward_expiry_months || undefined,
